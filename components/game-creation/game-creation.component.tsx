...
const GameCreation = ({ setViewData }: GameCreationProps) => {
	...
	return (
		<View style={styles.game_creation_view_container}>
			<View style={styles.input_container}>
				<Text>Name</Text>
				<TextInput placeholder="name" value={game.name} onChangeText={(value) => changeValue({ name: value })}></TextInput>
			</View>
			<View style={styles.input_container}>
				<Text>Credits</Text>
				<TextInput placeholder="credits" value={game.credits} onChangeText={(value) => changeValue({ credits: value })} keyboardType="numeric"></TextInput>
			</View>

			<View style={styles.input_container}>
				<Text>Time</Text>
				<TextInput placeholder="time" value={game.time} onChangeText={(value) => changeValue({ time: value })}></TextInput>
			</View>
			<View style={styles.input_container}>
				<Text>Blind</Text>
			...
			<View style={styles.input_container}>
				...
				<TextInput placeholder="maxPlayers" value={game.maxPlayers} onChangeText={(value) => changeValue({ maxPlayers: value })}></TextInput>
			</View>
			<StyledPressable
